...
public class HomeDayManagerTest {
    private static List<Habit> generateListOfHabits() {
        ...
        //once types
        list.add(new Habit(1, "once", "", false, 12, 12, 12, 60, 30, 30, 1, 0));
        list.add(new Habit(1, "once a week", "", false, 12, 12, 12, 60, 30, 30, 1, 7));
        list.add(new Habit(1, "once a year", "", false, 12, 12, 12, 60, 30, 30, 1, 365));
        //every ... types
        list.add(new Habit(1, "every sunday", "", false, 12, 12, 12, 60, 30, 30, 1, 1, 0));
        list.add(new Habit(1, "every monday", "", false, 12, 12, 12, 60, 30, 30, 1, 2, 0));
        list.add(new Habit(1, "every tuesday", "", false, 12, 12, 12, 60, 30, 30, 1, 3, 0));
        list.add(new Habit(1, "every wednesday", "", false, 12, 12, 12, 60, 30, 30, 1, 4, 0));
        list.add(new Habit(1, "every thursday", "", false, 12, 12, 12, 60, 30, 30, 1, 5, 0));
        list.add(new Habit(1, "every friday", "", false, 12, 12, 12, 60, 30, 30, 1, 6, 0));
        list.add(new Habit(1, "every saturday", "", false, 12, 12, 12, 60, 30, 30, 1, 7, 0));
        list.add(new Habit(1, "every day", "", false, 12, 12, 12, 60, 30, 30, 1, 1));
        //every ... and ... types
        list.add(new Habit(1, "every sunday and saturday", "", false, 12, 12, 12, 60, 30, 30, 1, 1, 7));
        list.add(new Habit(1, "every monday and friday", "", false, 12, 12, 12, 60, 30, 30, 1, 2, 6));
        list.add(new Habit(1, "every tuesday and thursday", "", false, 12, 12, 12, 60, 30, 30, 1, 3, 5));
        list.add(new Habit(1, "every wednesday and thursday", "", false, 12, 12, 12, 60, 30, 30, 1, 4, 5));
        return list;
    }
    ...
    public void filterForToday() {
        ...
        for (final Habit habit : list) {
            Assert.assertThat(String.format("  %s%n", habit.title),
                    habit.title.contains("once") || habit.title.contains(dayOfWeek)
