...
public class HabitDBHandler extends SQLiteOpenHelper implements HabitsDatabase {

    private static final String TAG = HabitDBHandler.class.getSimpleName();

    private static HabitsDatabase mHabitDatabase;
    ...
    private HabitDBHandler(final Context context) {
        super(context.getApplicationContext(), DATABASE_NAME, null, DATABASE_VERSION);
    }

    public static HabitsDatabase getHabitDatabase(final Context context) {
        if (mHabitDatabase == null) {
            mHabitDatabase = new HabitDBHandler(context.getApplicationContext());
        }
        return mHabitDatabase;
    }
