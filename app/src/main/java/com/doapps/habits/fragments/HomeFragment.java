...
public class HomeFragment extends Fragment implements IWeatherUpdater {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    if (ConnectionManager.isConnected(getContext())) {
      ...
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
        ...
        NetworkStateListener weatherNetworkStateListener
            = new WeatherNetworkStateListener(this, (MainActivity) getActivity());
  ...
  private String[] getDaysOfWeekFromToday(int dayOfWeek) {
    String[] daysOfWeekNames = getActivity().getResources()
        .getStringArray(R.array.days_of_week_array);
  ...
  private class GetTask extends AsyncTask<Void, Void, List<Habit>> {
    ...
    protected void onPostExecute(List<Habit> habits) {
      ...
      initDaysTabs(
          dayOfWeek,
          swipeSelector,
          new HomeDayManager(timeLineAdapter, habits));
